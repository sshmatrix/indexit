...
const Algorithm = (props) => {
  ...
  return (
    <div className="Minter">
      ...
      <h4 style={{ marginTop: '2px', marginLeft: '15px' }}><span style={{ fontWeight: 600 }}>999</span>, <span style={{ fontWeight: 600 }}>10k</span>, <span style={{ fontWeight: 600 }}>100k</span>, <span style={{ fontWeight: 600 }}>24h</span> & <span style={{ fontWeight: 600 }}>0<span style={{ fontFamily: 'SFMono', fontWeight: 400 }}>x</span>digit</span> clubs</h4>
      <h2 style={{ marginTop: '20px', marginLeft: '5px' }}>📓 CLUBS COMING SOON</h2>
      <h4 style={{ marginTop: '2px', marginLeft: '15px' }}><span style={{ fontWeight: 600 }}>Arabic</span> digits</h4>
      ...
      <h4 style={{ marginTop: '20px', marginLeft: '20px' }}>❗ 29/06/2022: bug reported during mainnet testing in backend queuing</h4>
      <h6 style={{ marginTop: '01px', marginLeft: '50px' }}>affected tokenid: 0-7, metadata-image mismatch</h6>
      <h4 style={{ marginTop: '20px', marginLeft: '20px' }}>⚠️ 29/06/2022: bug reported in opensea rendering</h4>
      <h6 style={{ marginTop: '01px', marginLeft: '50px' }}>affected tokenid: 0-11, 1:1 aspect ratio issue</h6>
      <h6 style={{ marginTop: '01px', marginLeft: '50px' }}>action taken: issue reported to opensea, fixed aspect ratio</h6>
