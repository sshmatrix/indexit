...
const Minter = (props) => {
    ...
    if (
      ...
      if ( addressResolve ) {
        if ( addressResolve.toLowerCase() === walletAddress.toLowerCase() ) {
          ...
          window.alert('❌ ENS digit does not resolve to connected wallet ✋')
          setStatus('❌ ENS digit does not resolve to connected wallet ✋');
        }
      } else {
        window.alert('❌ ENS digit does not resolve to connected wallet ✋')
        setStatus('❌ ENS digit does not resolve to connected wallet ✋');
  ...
  return (
    <div className="Minter">
      ...
      <div className="news blink_fast">
        <h4>📝 indexit now supports <span style={{ fontWeight: 200 }}>العربية</span>, <span style={{ fontWeight: 200 }}>中国人</span>, <span style={{ fontWeight: 200 }}>한국인</span>, <span style={{ fontWeight: 200 }}>فارسی</span>, <span style={{ fontWeight: 200 }}>देवनागरी</span> & roman digits
        </h4>
      </div>
      <br></br>
      <img className="img-front" alt="sample" src={sample}/>
      <h1 id="title">🚀 rarity cards for digit clubs</h1>
      <h2 style={{ marginTop: '10px' }}><span style={{ fontSize: 25 }}>🦊 </span> connect metamask</h2>
      <h4 style={{ marginTop: '10px' }}>connect wallet resolved by your digit name (requires a resolver)</h4>
      <h2 style={{ marginTop: '10px' }}><span style={{ fontSize: 25 }}>🕙 </span>  sign a timestamp to generate card</h2>
      <h4 style={{ marginTop: '10px' }}>why sign<span style={{ fontFamily: 'DM Mono' }}>?</span> unique verifiable signature will be printed on your card</h4>
      <h2 style={{ marginTop: '10px' }}><span style={{ fontSize: 25 }}>🖨️ </span>  mint your unique card</h2>
      {!walletAddress ? (
        <div className="form">
          <form style={{ marginBottom: '10px', width: '300px', justifyContent: 'center', display: 'flex' }}>
            <input
              id="ens"
              type="text"
      ...
      <br></br><br></br><br></br><br></br><br></br>
      {nft && !isMobile ? (
        <div style={{ justifyContent: 'center', display: 'flex', margin: '30px auto' }}><img alt="nft" src={nft} width="674" style={{ width:'674px', height:'400px', objectFit:'cover' }} /></div>
        ) : nft && isMobile ? (
        <div style={{ justifyContent: 'center', display: 'flex', margin: '-20px auto' }}><img alt="nft" src={nft} width="400" style={{ width:'400px', height:'238px', objectFit:'cover' }} /></div>
        ) : (
        <p></p>
      )}
      <h1 style={{ marginTop: '75px' }}>FAQ:</h1>
      <h2 style={{ marginTop: '20px' }}>🀄 what are rarity cards for digit clubs?</h2>
      <h4 style={{ marginTop: '20px' }}>rarity cards assign rarity to ens names in <span style={{ fontWeight: 600 }}>999</span>, <span style={{ fontWeight: 600 }}>10k</span>, <span style={{ fontWeight: 600 }}>100k</span> (<span style={{ fontWeight: 200 }}>中国人</span>, <span style={{ fontWeight: 200 }}>한국인</span>, <span style={{ fontWeight: 200 }}>فارسی</span>, english, <span style={{ fontWeight: 200 }}>العربية</span>, <span style={{ fontWeight: 200 }}>देवनागरी</span>) & <span style={{ fontWeight: 600 }}>24h</span>, <span style={{ fontWeight: 600 }}>0<span style={{ fontFamily: 'SFMono', fontWeight: 400 }}>x</span>digit</span>, roman clubs based on their mathematical properties. each card is unique to an ens name, printed with signature of the resolved wallet, thereby making it conceptually soulbound to an ens name (aka tokenbound token or tbt), but not contractually - yet. </h4>
      <h2 style={{ marginTop: '20px' }}>📚 link to collection?</h2>
      <h4 style={{ marginTop: '20px' }}><a style={{ color: 'blue', textDecoration: 'none' }} href="https://looksrare.org/collections/0x14aB45F6EdC154E338E27f8d1d2A7caD4ed62EC2" target='_blank' rel="noreferrer">looksrare</a> ✅, <a style={{ color: 'blue', textDecoration: 'none' }} href="https://rarible.com/collection/0x14aB45F6EdC154E338E27f8d1d2A7caD4ed62EC2" target='_blank' rel="noreferrer">rarible</a> ✅, <a style={{ color: 'blue', textDecoration: 'none' }} href="https://opensea.io/collection/iigenesis?search[sortAscending]=false&search[sortBy]=CREATED_DATE" target='_blank' rel="noreferrer">opensea</a> ✅</h4>
      <h2 style={{ marginTop: '20px' }}>📓 contract address?</h2>
      <h4 style={{ marginTop: '20px' }}><a style={{ color: 'blue', textDecoration: 'none' }} href="https://etherscan.io/address/0x14ab45f6edc154e338e27f8d1d2a7cad4ed62ec2" target='_blank' rel="noreferrer">0<span style={{ fontFamily: 'SFMono', fontWeight: 400 }}>x</span>14ab45f6 ... 4ed62ec2</a></h4>
      <h2 style={{ marginTop: '20px' }}>⏰ when can i mint?</h2>
      <h4 style={{ marginTop: '20px' }}>we are going live on <span style={{ fontWeight: 600 }}>mainnet on june 30 2022</span>.in the meantime, you can generate sample unsigned cards in the 'samples' tab.</h4>
      <h2 style={{ marginTop: '20px' }}>🍾 who can mint?</h2>
      <h4 style={{ marginTop: '20px' }}>wallet <span style={{ fontWeight: 600 }}>resolved</span> by an ens name in <span style={{ fontWeight: 600 }}>999, 10k, 100k</span> (<span style={{ fontWeight: 200 }}>中国人</span>, <span style={{ fontWeight: 200 }}>한국인</span>, <span style={{ fontWeight: 200 }}>فارسی</span>, english, <span style={{ fontWeight: 200 }}>العربية</span>, <span style={{ fontWeight: 200 }}>देवनागरी</span>) & <span style={{ fontWeight: 600 }}>24h</span>, <span style={{ fontWeight: 600 }}>0<span style={{ fontFamily: 'SFMono', fontWeight: 400 }}>x</span>digit</span>, roman club can mint.you can only mint the card for an ens digit for which a resolver is set pointing to your wallet. ownership (registrant) or control (controller) is not necessary.</h4>
      <h2 style={{ marginTop: '20px' }}>💸 what's the mint price?</h2>
      <h4 style={{ marginTop: '20px' }}><span style={{ fontWeight: 600 }}>3l </span>clubs: 0.050 eth + gas (<span style={{ fontWeight: 200 }}>中国人</span>, <span style={{ fontWeight: 200 }}>한국인</span>, <span style={{ fontWeight: 200 }}>فارسی</span>, english, <span style={{ fontWeight: 200 }}>العربية</span>, <span style={{ fontWeight: 200 }}>देवनागरी</span> 999 & 0<span style={{ fontFamily: 'SFMono', fontWeight: 400 }}>x</span>1l)</h4>
      <h4 style={{ marginTop: '20px' }}><span style={{ fontWeight: 600 }}>4l </span>clubs: 0.010 eth + gas (<span style={{ fontWeight: 200 }}>中国人</span>, <span style={{ fontWeight: 200 }}>한국인</span>, <span style={{ fontWeight: 200 }}>فارسی</span>, english, <span style={{ fontWeight: 200 }}>العربية</span>, <span style={{ fontWeight: 200 }}>देवनागरी</span> 10k & 0<span style={{ fontFamily: 'SFMono', fontWeight: 400 }}>x</span>2l)</h4>
      <h4 style={{ marginTop: '20px' }}><span style={{ fontWeight: 600 }}>5l </span>clubs: 0.005 eth + gas (24h, <span style={{ fontWeight: 200 }}>中国人</span>, <span style={{ fontWeight: 200 }}>한국인</span>, <span style={{ fontWeight: 200 }}>فارسی</span>, english, <span style={{ fontWeight: 200 }}>العربية</span>, <span style={{ fontWeight: 200 }}>देवनागरी</span> 100k, roman & 0<span style={{ fontFamily: 'SFMono', fontWeight: 400 }}>x</span>3l, 0<span style={{ fontFamily: 'SFMono', fontWeight: 400 }}>x</span>4l, 0<span style={{ fontFamily: 'SFMono', fontWeight: 400 }}>x</span>5l)</h4>
      <h4 style={{ marginTop: '10px' }}>🎁 card holders will be eligible for premium zero-cost features in the future, such as wrapped subdomains hosting their digiverse, card drops on polygon and more.check out the roadmap below.</h4>
      <h2 style={{ marginTop: '20px' }}>⚙️ what criteria are tested for rarity?</h2>
      <h4 style={{ marginTop: '20px' }}>the algorithm checks for whether the number is <span style={{ fontWeight: 600 }}>even</span>, <span style={{ fontWeight: 600 }}>odd</span>, <span style={{ fontWeight: 600 }}>palindrome</span>, has <span style={{ fontWeight: 600 }}>repeating</span>, <span style={{ fontWeight: 600 }}>alternating</span> and/or <span style={{ fontWeight: 600 }}>incrementing</span> characters, and <span style={{ fontWeight: 600 }}>69</span> types (honest coincidence 😋) of <span style={{ fontWeight: 600 }}>primes</span>.types of primes checked by the algorithm are: </h4>
      {width > 1050 ? (
      ...
      <h4 style={{ marginTop: '20px' }}>indexit.eth subdomains for card holders, support non-digit ens, and more!</h4>
      <br></br>
      <img style={{ justifyContent: 'center', display: 'flex', margin: '0 auto' }} alt="roadmap" src={roadmap} height="750" />
      <br></br>
